...
class ARKitNode {
  ARKitNode({
    ...
    String name,
        ...
        lookAt = ValueNotifier(lookAt ?? Vector3.zero()),
        pivot = ValueNotifier(pivot ?? Matrix4.zero()),
        opacity = ValueNotifier(opacity ?? 1.0);
  ...
  final ValueNotifier<Vector3> lookAt;

  /// Determines the receiver's opacity.
  ...
  Map<String, dynamic> toMap() => <String, dynamic>{
        ...
        'lookAt': _vector3ValueNotifierConverter.toJson(lookAt),
